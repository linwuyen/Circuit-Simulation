(() => {
  ...
  function installRemediation(layer) {
    ...
    box.innerHTML = `
      ...
      <p><a href="../15_power_capstone/lab_sandbox.html?remediation=${({physics:'physics',sensing:'unit',timing:'timing',dynamics:'model'})[layer] || 'model'}&learnFrom=core-${layer}#training-remediation">需要多一步？依錯誤分類做短實驗，再換條件驗證</a></p>
