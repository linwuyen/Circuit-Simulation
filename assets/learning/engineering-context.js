(function(root,factory){const api=factory();if(typeof module==='object'&&module.exports)module.exports=api;root.CircuitEngineeringContext=api;})(globalThis,function(){
  ...
  function resolve(input,owners){
    ...
    const number=continuous?15:home||shared?0:entry?.number;
    ...
    return {known,status:known?'MODEL_ONLY':'UNKNOWN',path,moduleNumber:number,title:home?(continuous?'連續電路實驗':'入門工作台'):shared?'同一案例的模型鏡頭':entry?.title||'尚未登錄的頁面',
