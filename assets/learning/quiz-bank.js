(function (root, factory) {
  ...
  const questions = [
{"id": "topology-pfc-scaling", "moduleId": "power-topology-control", "competency": "topology.pfc.bus-energy", "kind": "交流整流：電容與輸出起伏", "prompt": "輸出功率、母線電壓與電源頻率不變，把母線電容加倍，理想電壓起伏約變成多少？", "options": [{"id": "correct", "text": "原來的一半", "correct": true, "feedback": "電容越大，相同能量變動造成的電壓變化越小；這不能直接證明輸入電流品質。"}, {"id": "linear", "text": "原來的兩倍", "correct": false, "feedback": "電容越大，相同能量變動造成的電壓變化越小；這不能直接證明輸入電流品質。", "misconception": "把模型比例或驗證層級混為一談"}, {"id": "same", "text": "保持不變", "correct": false, "feedback": "電容越大，相同能量變動造成的電壓變化越小；這不能直接證明輸入電流品質。", "misconception": "把模型比例或驗證層級混為一談"}, {"id": "board", "text": "代表實板已驗證通過", "correct": false, "feedback": "理想關係的作答不能替代實板量測。", "misconception": "把模型比例或驗證層級混為一談"}], "href": "17_power_topology_control/index.html#pfc"},
{"id": "topology-psfb-scaling", "moduleId": "power-topology-control", "competency": "topology.psfb.commutation-energy", "kind": "隔離電源：切換時的能量", "prompt": "漏感與所需切換能量不變，電流降成一半，漏感儲能約變成多少？", "options": [{"id": "correct", "text": "原來的四分之一", "correct": true, "feedback": "儲能與電流平方成正比；能量足夠仍不等於實板已達成零電壓切換。"}, {"id": "linear", "text": "原來的一半", "correct": false, "feedback": "儲能與電流平方成正比；能量足夠仍不等於實板已達成零電壓切換。", "misconception": "把模型比例或驗證層級混為一談"}, {"id": "same", "text": "保持不變", "correct": false, "feedback": "儲能與電流平方成正比；能量足夠仍不等於實板已達成零電壓切換。", "misconception": "把模型比例或驗證層級混為一談"}, {"id": "board", "text": "代表實板已驗證通過", "correct": false, "feedback": "理想關係的作答不能替代實板量測。", "misconception": "把模型比例或驗證層級混為一談"}], "href": "17_power_topology_control/index.html#psfb"},
{"id": "topology-llc-scaling", "moduleId": "power-topology-control", "competency": "topology.llc.resonance", "kind": "諧振電源：電容與自然頻率", "prompt": "諧振電感不變，把諧振電容變成四倍，串聯諧振頻率約變成多少？", "options": [{"id": "correct", "text": "原來的一半", "correct": true, "feedback": "自然頻率與電容平方根成反比；這不是完整負載暫態或控制穩定性結論。"}, {"id": "linear", "text": "原來的四分之一", "correct": false, "feedback": "自然頻率與電容平方根成反比；這不是完整負載暫態或控制穩定性結論。", "misconception": "把模型比例或驗證層級混為一談"}, {"id": "same", "text": "保持不變", "correct": false, "feedback": "自然頻率與電容平方根成反比；這不是完整負載暫態或控制穩定性結論。", "misconception": "把模型比例或驗證層級混為一談"}, {"id": "board", "text": "代表實板已驗證通過", "correct": false, "feedback": "理想關係的作答不能替代實板量測。", "misconception": "把模型比例或驗證層級混為一談"}], "href": "17_power_topology_control/index.html#llc"},
{"id": "topology-inverter-scaling", "moduleId": "power-topology-control", "competency": "topology.inverter.filter-resonance", "kind": "逆變器：濾波器的自然頻率", "prompt": "理想 LCL 濾波器的兩個電感不變，電容變成四倍，共振頻率約變成多少？", "options": [{"id": "correct", "text": "原來的一半", "correct": true, "feedback": "共振頻率與電容平方根成反比；實際阻尼、電網阻抗和控制延遲仍須另外確認。"}, {"id": "linear", "text": "原來的四倍", "correct": false, "feedback": "共振頻率與電容平方根成反比；實際阻尼、電網阻抗和控制延遲仍須另外確認。", "misconception": "把模型比例或驗證層級混為一談"}, {"id": "same", "text": "保持不變", "correct": false, "feedback": "共振頻率與電容平方根成反比；實際阻尼、電網阻抗和控制延遲仍須另外確認。", "misconception": "把模型比例或驗證層級混為一談"}, {"id": "board", "text": "代表實板已驗證通過", "correct": false, "feedback": "理想關係的作答不能替代實板量測。", "misconception": "把模型比例或驗證層級混為一談"}], "href": "17_power_topology_control/index.html#inverter"},
    {
